...
class PC extends React.Component {
  ...
  openModal() {
    ...
    axios.get('http://123.207.75.151:9996/bitrun/api/v1/get_image/1').then((res) => {
      console.log(res)
  ...
  render() {
    return (
      <div>
        ...
        <Modal isOpen={this.state.modalIsOpen} onRequestClose={this.closeModal} style={modalStyle} contentLabel="">
